...
SECRET_KEY = 'django-insecure-88(4(h8in*ls&rbioyw(d^!ssl)@gr3pkhh=_se1%bm!79%+g3'
...
STELLAR_SERVER = Server("https://horizon-testnet.stellar.org")  # Use mainnet URL for production
